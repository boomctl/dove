...
[AWS CLI](https://aws.amazon.com/cli/) (provisioning shells out to it). It depends
on the [dove-core](https://crates.io/crates/dove-core) library from crates.io, so
a single clone builds on its own:
